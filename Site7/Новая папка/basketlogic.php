    ...
    else
    {
        ...
        <h4 class="u-text u-text-default u-text-5">Итого: '.$totalSum.' руб.</h4>
                ...
                <form action="addorder.php" method="post" style="width: 100pt;">
                    ...
                    <button type="submit" class="u-active-custom-color-13 u-border-2 u-border-grey-75 u-btn u-btn-round u-button-style u-custom-color-1 u-hover-custom-color-12 u-btn-4">Оформить</button>
                </form>
